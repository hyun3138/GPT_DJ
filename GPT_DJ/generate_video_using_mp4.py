...
def combine_videos_and_music(mp3_files, video_files, titles, artists, output_filename):
    ...
    # 하나로 합쳐진 동영상의 길이와 플레이리스트의 길이 비교하기
    ...
    compostie_clips=[concat_video] + [text for text_group in text_clips for text in text_group]
    final_video=CompositeVideoClip(compostie_clips)
...
if __name__ == '__main__':
    video_files=[
        "./videos/dji/DJI_20230502091852_0074_D.MP4",
        "./videos/dji/DJI_20230502091254_0073_D.MP4"
    ]

    csv_file='./playlist/2020s_hiphop.csv'
